...
for t = 2:position
    ...
    speed_eve = min(max(speed_g(t)+rand*Vrange,0),Vmax);
    theta_eve = wrapTo2Pi(theta_g(t) + rand*Trange);
    [Xeve(t),Yeve(t),theta_eve] = func_next_position...
        (Xeve(t-1),Yeve(t-1),speed_eve,theta_eve,Xmax,Ymax);
    Zeve(t) = Zeve(t-1);
end
...
% pos_src = [10.1 11.2 2; 10.2 11.3 2; 10.3 11.4 2; ...
%     10.4 11.5 2; 10.5 11.6 2; 11.1 16.2 2; 11.3 16.4 2];
% pos_uav = [15.2 12.3 10; 15.3 12.4 10; 15.4 12.5 10; ...
%     15.5 12.6 10; 15.6 12.7 10; 16.2 17.3 10; 16.4 14.5 10];
% pos_des = [20.3 13.4 2; 20.4 13.5 2; 20.5 13.6 2; ...
%     20.6 13.7 2; 20.7 13.8 2; 20.3 18.4 2; 20.5 18.6 2];
% pos_eve = [25.4 14.5 1; 25.5 14.6 1; 25.6 14.7 1; ...
%     25.7 14.8 1; 25.8 14.9 1; 25.4 19.5 1; 25.6 19.7 1];
